...
#train_set = pd.read_csv("Tm-1.txt",sep="\t").dropna().drop_duplicates()
train_set = pd.read_csv("../Tm.txt",sep="\t").dropna().drop_duplicates()
...
for epoch_i in range(0, epochs):
    ...
    for i in range(0, len(train_set), batch_size):
        ...
        batch_labels = train_set["Tm"][i:i+batch_size]
    ...
    for i in range(0, len(valid_set), batch_size):
        ...
        batch_labels = valid_set["Tm"][i:i+batch_size]
        batch_labels = batch_labels.tolist() 
