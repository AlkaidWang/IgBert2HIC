...
optimizer = AdamW(model.parameters(), lr=1e-6)         #optimal 5e-5
scheduler = StepLR(optimizer, step_size=20, gamma=0.2)  # 每10个epoch，学习率下降为原来的0.2倍

train_set = pd.read_csv("../HIC.txt",sep="\t").dropna().drop_duplicates()
